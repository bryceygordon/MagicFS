...
### Core Mechanics
* **Instant Search:** The app lists `/magic/search/"query"` instead of querying a database.
* **Context Previews:** Instead of parsing PDFs, the app reads `_CONTEXT.md` generated by MagicFS to show *why* a file matched.
* **Smart Sidebar:** A live view of `/magic/saved/` folders. Changing a folder in the terminal updates the GUI instantly.
